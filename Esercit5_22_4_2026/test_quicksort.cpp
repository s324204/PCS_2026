...
// COMPILARE INCLUDENTO TIMECOUNTER.CPP: g++ -std=c++20 test_quicksort.cpp timecounter.cpp -o test_quicksort
...
// Testiamo su vettore di stringhe:
    ...
    quicksort(vec_string, s, d);
    cout << "Vettore di stringhe (quicksort): ";
